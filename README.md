...
- Pod debugging workspace with status, containers, events, searchable source- and level-filtered logs, exec command handoff, guarded restart, and guarded delete.
