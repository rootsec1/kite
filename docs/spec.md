...
- Multi-cluster Kubernetes cockpit with scoped resource exploration, sortable signal-aware inventory, guarded actions, searchable log workflows, YAML/diff inspection, and a simple visual control-plane map.
